...
public class Level1 {
  ...
  int count, level, numOfLives, lose = 0;                              //num of counts since starting the program, current level, num of lives                                                // current level number
  ...
  Level1(int num, String bg, String yWin, String yLose, String gOver, 
    ...
    String l1, Alien a, float[][] alienPos) {
    level = num;
