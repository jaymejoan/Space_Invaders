...
public class Level3 {
  PImage background, gameOver, youWin, selectContinue, selectMenu, neonBox, level3Sign, scoreSign, livesSign;                      
  ...
  // Constructor
  Level3(int num, String bg, String yWin, String gOver, String c, String m, String nb, String l3, String s, String l, Alien a, float[][] alienPos) {
    level = num;
