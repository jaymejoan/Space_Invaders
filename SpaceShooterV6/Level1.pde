...
public class Level1 {
  ...
  //int count, level, numOfLives, lose = 0, currentScore;                                   //num of counts since starting the program, current level, num of lives                                                
  ...
  Level1(int num, String bg, String yWin, String yLose, String gOver, 
    ...
    sObject = scoreObject;
    //rTimeRed = randomTimeRed;
    //rTimeRed2 = randomTimeRed2;
    //rTimeBlue = randomTimeBlue;
    ...
    rTimeBlue = (int)random(300, 650);   //randomly generated time for the blue powerup to appear

    println("random red: " + rTimeRed);
    println("random red2: " + rTimeRed2);
    println("random blue: " + rTimeBlue);
  }
  ...
  void redraw(int counter, int lives) {
    ...
    count = counter;  
    if (initialiser == 0) {
      println("initialiser: " + initialiser);
      numOfLives = lives;
